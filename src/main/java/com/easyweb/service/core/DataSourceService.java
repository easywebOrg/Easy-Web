...
public interface DataSourceService {
     ...
     */
    public static String DEFAULT_DATASOURCE_CONFIG_FILE_PATH = "../spring/default-datasource.xml";

    /**
     * proxool管理的默认数据源配置文件位置
     */
    public static String DEFAULT_PROXOOL_CONFIG_FILE_PATH = "../conf/proxool.xml";

    /**
     * proxool管理的默认数据源名称
     */
    public static String DEFAULT_PROXOOL_CONNECTION_NAME = "easyweb";
